namespace ts {
    ...
    export interface TypeChecker {
        ...
        /* @internal */ isValidPropertyAccessForCompletions(node: PropertyAccessExpression | ImportTypeNode, type: Type, property: Symbol, timechecks?: { name: string; time: number;}[]): boolean;
